...
# Load environment
# On droplet: __file__ = /opt/taskhive/repo/agents/base_agent.py → parent.parent = repo/
# Locally:    __file__ = TaskHive/scripts/agents/base_agent.py  → parent.parent.parent = TaskHive/
